 ...
 */var Ig;function bx(){if(Ig)return mo;Ig=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,u){var h=null;if(u!==void 0&&(h=""+u),l.key!==void 0&&(h=""+l.key),"key"in l){u={};for(var d in l)d!=="key"&&(u[d]=l[d])}else u=l;return l=u.ref,{$$typeof:o,type:r,key:h,ref:l!==void 0?l:null,props:u}}return mo.Fragment=e,mo.jsx=i,mo.jsxs=i,mo}var Fg;function Ax(){return Fg||(Fg=1,Df.exports=bx()),Df.exports}var Et=Ax(),Uf={exports:{}},ae={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
#define LOW_PRECISION`),e}function fb(o){let e="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===W_?e="SHADOWMAP_TYPE_PCF":o.shadowMapType===Fx?e="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Ki&&(e="SHADOWMAP_TYPE_VSM"),e}function hb(o){let e="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case gs:case _s:e="ENVMAP_TYPE_CUBE";break;case Tc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function db(o){let e="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case _s:e="ENVMAP_MODE_REFRACTION";break}return e}function pb(o){let e="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case q_:e="ENVMAP_BLENDING_MULTIPLY";break;case aS:e="ENVMAP_BLENDING_MIX";break;case rS:e="ENVMAP_BLENDING_ADD";break}return e}function mb(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:r,maxMip:i}}function gb(o,e,i,r){const l=o.getContext(),u=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=fb(i),p=hb(i),g=db(i),v=pb(i),x=mb(i),y=ib(i),b=ab(u),C=l.createProgram();let M,_,B=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+_);const N=B+M+h,w=B+_+d,F=P_(l,l.VERTEX_SHADER,N),I=P_(l,l.FRAGMENT_SHADER,w);l.attachShader(C,F),l.attachShader(C,I),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function z(G){if(o.debug.checkShaderErrors){const ot=l.getProgramInfoLog(C).trim(),st=l.getShaderInfoLog(F).trim(),_t=l.getShaderInfoLog(I).trim();let ft=!0,O=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(ft=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,F,I);else{const Z=z_(l,F,"vertex"),q=z_(l,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
...
[n][n]
[b:~ Eric]
`;function sA(){const[o,e]=rn.useState(!0),[i,r]=rn.useState("0px"),[l,u]=rn.useState(!1),[h,d]=rn.useState(!1),[m,p]=rn.useState(null),[g,v]=rn.useState(!window.location.search.substring(1).split("&").includes("light")),x=rn.useRef(null),y=rn.useRef(null),b=rn.useRef(null),C=rn.useRef(null),M=rn.useRef(hh.map(()=>rn.createRef())),_=()=>{u(!0),setTimeout(()=>{u(!1)},2e3)},B=()=>{d(!0),setTimeout(()=>{d(!1)},2e3)};rn.useEffect(()=>{const F=()=>{const I=document.getElementById("root");if(!I)return;const z=I.getBoundingClientRect(),X=window.innerWidth;if(z.right<X-140){const D=(X-z.right)/3+"px";r(D),e(!0)}else e(!1)};return F(),window.addEventListener("resize",F),()=>window.removeEventListener("resize",F)},[]),rn.useEffect(()=>{const F={root:null,rootMargin:"0px",threshold:.5},I=new IntersectionObserver(z=>{z.forEach(X=>{const D=M.current.findIndex(R=>R.current===X.target);D!==-1&&X.isIntersecting?p(D):D===m&&!X.isIntersecting&&(z.some(G=>G.isIntersecting&&G.target!==X.target)||p(null))})},F);return M.current.forEach(z=>{z.current&&I.observe(z.current)}),()=>{M.current.forEach(z=>{z.current&&I.unobserve(z.current)})}},[m]);const N=F=>{M.current[F]&&M.current[F].current&&M.current[F].current.scrollIntoView({behavior:"smooth",block:"center"})},w=()=>{v(!g)};return rn.useEffect(()=>{g?document.documentElement.classList.add("dark-mode"):document.documentElement.classList.remove("dark-mode")},[g]),rn.useEffect(()=>{const F=()=>{const I=[x,C,y],z=window.innerHeight*.4,X=window.innerHeight*.7;if(I.forEach(D=>{if(D.current){const{top:R}=D.current.getBoundingClientRect();R<z?D.current.classList.add("scrolled-past"):D.current.classList.remove("scrolled-past")}}),b.current){const{top:D}=b.current.getBoundingClientRect();D<X?b.current.classList.add("scrolled-past"):b.current.classList.remove("scrolled-past")}};return window.addEventListener("scroll",F,{passive:!0}),F(),()=>{window.removeEventListener("scroll",F)}},[]),Et.jsxs(Et.Fragment,{children:[Et.jsxs("div",{id:"app-container",className:g?"dark-mode":"",children:[Et.jsx("div",{className:`dark-mode-hint ${g?"dark-mode":""}`,children:"Try me!"}),Et.jsx(Wb,{}),Et.jsxs("div",{className:"header-container",children:[Et.jsxs("div",{className:"profile-picture-container",id:"profile-picture-container",children:[Et.jsx("img",{src:Px,alt:"Eric Li",className:"profile-picture"}),Et.jsx("img",{src:Bx,alt:"Eric Li Back",className:"profile-picture-back"})]}),Et.jsxs("div",{className:"header-text",children:[Et.jsxs("h1",{children:["Hi, I'm ",Et.jsx("div",{onClick:_,className:`inline hover-offset bolded name-clickable ${l?"show-chinese":""}`,children:"Song Yu Li."})]}),Et.jsxs("h2",{children:["But you can call me ",Et.jsx("div",{onClick:B,className:`inline hover-offset blue-name bolded nickname-clickable ${h?"show-emoji":""}`,children:"Eric"}),"."]})]})]}),Et.jsxs("div",{className:"by-lines",children:[Et.jsxs("p",{className:"by-line right-pulse-dot dark-yellow",children:["→  Computer Science student at ",Et.jsx("a",{href:"https://uwaterloo.ca/",target:"_blank",rel:"noopener noreferrer",className:"inline hover-offset yellow-text bolded",children:"UWaterloo"}),"."]}),Et.jsxs("p",{className:"by-line right-pulse-dot dark-blue",children:["→  Previously at ",Et.jsx("a",{href:"https://www.ford.com/",target:"_blank",rel:"noopener noreferrer",className:"inline hover-offset blue-text bolded",children:"Ford"}),", ",Et.jsx("a",{href:"https://summerofcode.withgoogle.com/",target:"_blank",rel:"noopener noreferrer",className:"inline hover-offset blue-text bolded",children:"GSoC"}),"."]}),Et.jsxs("p",{className:"by-line right-pulse-dot dark-red",children:["→  Incoming Software Engineer Intern at ",Et.jsx("a",{href:"https://www.toma.com/",target:"_blank",rel:"noopener noreferrer",className:"inline hover-offset red-text bolded",children:"Toma"}),"."]})]}),Et.jsx("div",{className:"cover-letter-container",children:Et.jsx("p",{className:"cover-letter",children:yv(window.location.search.substring(1).split("&")[0]==="toma"?rA:"")})}),Et.jsxs("div",{className:"content-container",children:[Et.jsx("h3",{className:"fade-in-2",ref:x,children:"Projects"}),Et.jsx("div",{className:"projects-container fade-in-3",children:hh.map((F,I)=>Et.jsx("div",{ref:M.current[I],children:Et.jsx(iA,{project:F,index:I})},I))})]}),Et.jsxs("div",{className:"skills-container",children:[Et.jsx("h3",{className:"fade-in-2",ref:C,children:"Skills"}),Et.jsx("div",{className:"skills-list-container",children:Et.jsx("div",{className:"skills-list",children:aA.map((F,I)=>Et.jsx("p",{className:`skills-line ${I%2===0?"right-pulse-dot":"left-pulse-dot"} ${F.color}`,children:F.title},I))})})]}),Et.jsxs("div",{className:"resume-container",children:[Et.jsx("h3",{className:"fade-in-2",ref:y,children:"Resume"}),Et.jsx("div",{className:"resume",children:Et.jsxs("object",{className:"pdf",data:dh,style:{width:"100%",height:"100vh",backgroundColor:"white",zIndex:1},children:[Et.jsx("div",{children:Et.jsx("embed",{src:dh,style:{height:"intrinsic"}})}),Et.jsxs("p",{className:"pdf-warning",children:["This browser does not support PDFs. Please ",Et.jsx("a",{href:dh,download:!0,children:"download the PDF"})," to view it."]})]})})]}),Et.jsxs("div",{className:"contact-container",id:"contact-container",children:[Et.jsx("h3",{className:"fade-in-2",ref:b,children:"Contact"}),Et.jsxs("p",{children:["Open to work and actively searching for opportunities.",Et.jsx("br",{}),"Feel free to reach out."]}),Et.jsxs("div",{className:"contact-links",children:[Et.jsx("a",{href:"mailto:ericli3690@gmail.com",className:"contact-link right-pulse-dot fade-in-3",children:"→  ericli3690@gmail.com"}),Et.jsx("a",{href:"tel:+14035616028",className:"contact-link right-pulse-dot fade-in-3",children:"→  +1 (403) 561-6028"}),Et.jsx("a",{href:"https://github.com/ericli3690",target:"_blank",rel:"noopener noreferrer",className:"contact-link right-pulse-dot fade-in-3",children:"→  github.com/ericli3690"}),Et.jsx("a",{href:"https://www.linkedin.com/in/song-eric-li/",target:"_blank",rel:"noopener noreferrer",className:"contact-link right-pulse-dot fade-in-3",children:"→  linkedin.com/in/song-eric-li"})]})]}),Et.jsx("div",{className:"footer-container",children:Et.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",justifyContent:"center"},children:[Et.jsx("a",{href:"https://cs.uwatering.com/#https://ericli3690.github.io/?nav=prev",children:"←"}),Et.jsx("a",{href:"https://cs.uwatering.com/#https://ericli3690.github.io/",target:"_blank",children:Et.jsx("img",{src:g?"https://cs.uwatering.com/icon.white.svg":"https://cs.uwatering.com/icon.black.svg",alt:"CS Webring",style:{width:"24px",height:"auto",opacity:.8}})}),Et.jsx("a",{href:"https://cs.uwatering.com/#https://ericli3690.github.io/?nav=next",children:"→"})]})})]}),o&&Et.jsxs("div",{className:"left-links-bar",style:{left:i},children:[Et.jsx("a",{className:"icon-link",href:"#contact-container","aria-label":"Email",children:Et.jsx("svg",{className:"icon",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:Et.jsx("path",{d:"M20,4H4C2.9,4,2,4.9,2,6v12c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V6C22,4.9,21.1,4,20,4z M20,8l-8,5L4,8V6l8,5l8-5V8z"})})}),Et.jsx("a",{className:"icon-link",href:"#contact-container","aria-label":"Phone",children:Et.jsx("svg",{className:"icon",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:Et.jsx("path",{d:"M6.62,10.79C8.06,13.62,10.38,15.94,13.21,17.38L15.41,15.18C15.69,14.9,16.08,14.82,16.43,14.93C17.55,15.3,18.75,15.5,20,15.5A1,1,0,0,1,21,16.5V20A1,1,0,0,1,20,21A17,17,0,0,1,3,4A1,1,0,0,1,4,3H7.5A1,1,0,0,1,8.5,4C8.5,5.25,8.7,6.45,9.07,7.57C9.18,7.92,9.1,8.31,8.82,8.59L6.62,10.79Z"})})}),Et.jsx("a",{className:"icon-link",href:"https://github.com/ericli3690",target:"_blank",rel:"noopener noreferrer","aria-label":"GitHub",children:Et.jsx("svg",{className:"icon",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:Et.jsx("path",{d:"M12,2A10,10,0,0,0,8.84,21.5c.5.08.66-.23.66-.5V19.31C6.73,19.91,6.14,18,6.14,18A2.69,2.69,0,0,0,5,16.5c-.91-.62.07-.6.07-.6a2.1,2.1,0,0,1,1.53,1,2.15,2.15,0,0,0,2.91.83,2.16,2.16,0,0,1,.63-1.34C8,16.17,5.62,15.31,5.62,11.5a3.87,3.87,0,0,1,1-2.71,3.58,3.58,0,0,1,.1-2.64s.84-.27,2.75,1a9.63,9.63,0,0,1,5,0c1.91-1.29,2.75-1,2.75-1a3.58,3.58,0,0,1,.1,2.64,3.87,3.87,0,0,1,1,2.71c0,3.82-2.34,4.66-4.57,4.91a2.39,2.39,0,0,1,.69,1.85V21c0,.27.16.59.67.5A10,10,0,0,0,12,2Z"})})}),Et.jsx("a",{className:"icon-link",href:"https://www.linkedin.com/in/song-eric-li/",target:"_blank",rel:"noopener noreferrer","aria-label":"LinkedIn",children:Et.jsx("svg",{className:"icon",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:Et.jsx("path",{d:"M19,3A2,2,0,0,1,21,5V19a2,2,0,0,1-2,2H5a2,2,0,0,1-2-2V5A2,2,0,0,1,5,3H19M18.5,18.5V13.2A3.26,3.26,0,0,0,15.24,9.9a3.17,3.17,0,0,0-2.32.95V10.13H9.5V18.5h3.4V13.57c0-.9.18-1.56,1.3-1.56s1.3.86,1.3,1.56V18.5Z M6.88,8.56A1.68,1.68,0,0,0,8.56,6.88,1.69,1.69,0,0,0,6.88,5.19,1.69,1.69,0,0,0,5.19,6.88,1.68,1.68,0,0,0,6.88,8.56M8.27,18.5V10.13H5.21V18.5Z"})})})]}),Et.jsx("button",{className:`dark-mode-toggle ${g?"dark-mode":""}`,onClick:w,"aria-label":"Toggle dark mode",children:Et.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor",className:"moon-icon",children:Et.jsx("path",{d:"M21.53 15.93c-.16-.27-.61-.69-1.73-.49a8.46 8.46 0 01-1.88.13 8.409 8.409 0 01-5.91-2.82 8.068 8.068 0 01-1.44-8.66c.44-1.01.13-1.54-.09-1.76s-.77-.55-1.83-.11a10.318 10.318 0 00-6.32 10.21 10.475 10.475 0 007.04 8.99 10 10 0 002.89.55c.16.01.32.02.48.02a10.5 10.5 0 008.47-4.27c.67-.93.49-1.519.32-1.79z"})})}),o&&Et.jsx("div",{className:"right-scroll-indicator",style:{right:i},children:hh.map((F,I)=>Et.jsx("div",{className:`right-scroll-dot ${m===I?"active":""}`,onClick:()=>N(I)},I))})]})}Ox.createRoot(document.getElementById("root")).render(Et.jsx(rn.StrictMode,{children:Et.jsx(sA,{})}));
